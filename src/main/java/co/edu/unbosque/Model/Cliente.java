...
public class Cliente {
	 ...
	 * @return
	 */
	Cliente(String nombre, String apellido, String email, String telefono, String direccion, String userPassword,
			boolean frecuente, LocalDateTime fechaRegistro, boolean ctaBloqueada) {
		this.nombre = nombre;
